...
carritoBoton = function () {
  ...
  let elementosCarrito;
    ...
    contenidoTabla += '<tr><td>' + elementosCarrito.nombre + '</td>'
      + '<td>' + elementosCarrito.cantidad + '</td>'
      + '<td>' + elementosCarrito.precio + '</td>'
      + '</tr>';
...
function agregarAlCarrito(nombreProducto) {
  /*
    ...
    */
  let indiceProductoEnCarrito;
  indiceProductoEnCarrito = buscarCarrito(nombreProducto);
  if (indiceProductoEnCarrito !== null) {
    carrito[indiceProductoEnCarrito].cantidad++;
    console.log("le agrego al carrito")
  } else {
    let productoNew = {}
    productoNew.nombre = nombreProducto;
    productoNew.cantidad = 1;
    productoNew.precio = 0;
...
function eliminarDelCarrito(index) {
  /*
      ...
      - Actualizar tabla y total
    */
  if (buscarCarrito(carrito[index].nombre)) {
